...
def addContact():
	...
	if freshCategory == 'friend':
		...
		#contact_dic[freshName] = Friend(freshName, freshAge, freshSex, freshCategory, freshHobby)#({freshName:})
		contact_dic[freshName] = {'name':freshName,'age':freshAge, 'sex':freshSex, 'category':freshCategory, 'hobby':freshHobby}
		
		#p.dump({freshName:Friend(freshName, freshAge, freshSex, freshCategory, freshHobby)}, f) 

	elif freshCategory == 'family':
		freshNickname = raw_input('Enter nickName-->')
		#contact_dic[freshName] = Family(freshName, freshAge, freshSex, freshCategory, freshNickname)
		...
		#p.dump({freshName:Family(freshName, freshAge, freshSex, freshCategory, freshNickname)}, f)
